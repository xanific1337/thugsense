...
do
    ...
    local CoreGui = cloneref and cloneref(game:GetService('CoreGui'))
    ...
    for _, ImageData in Library.Images do
        ...
        if not isfile(Library.Folders.Assets .. '/' .. ImageName) then
            writefile(
                Library.Folders.Assets .. '/' .. ImageName,
                game:HttpGet(ImageLink)
            )
        end
    end
        ...
        Instances.MakeResizeable = function(self, Minimum, Maximum)
            ...
            ResizeButton:Connect('InputBegan', function(Input)
                ...
                then
                    ...
                    Start = Gui.Size
                        - UDim2New(0, Input.Position.X, 0, Input.Position.Y)
                end
            end)
            ...
            Library:Connect(UserInputService.InputChanged, function(Input)
                ...
                then
                    ResizeMax = Maximum
                        or Gui.Parent.AbsoluteSize - Gui.AbsoluteSize
    ...
    do
        function CustomFont:New(Name, Weight, Style, Data)
            if isfile(Library.Folders.Assets .. '/' .. Name .. '.json') then
                return Font.new(
                    getcustomasset(
                        Library.Folders.Assets .. '/' .. Name .. '.json'
                    )
                )
            end
            ...
            if not isfile(Library.Folders.Assets .. '/' .. Name .. '.ttf') then
                writefile(
                    Library.Folders.Assets .. '/' .. Name .. '.ttf',
            ...
            writefile(
                Library.Folders.Assets .. '/' .. Name .. '.json',
                HttpService:JSONEncode(FontData)
            )
            return Font.new(
                getcustomasset(Library.Folders.Assets .. '/' .. Name .. '.json')
            )
        end
        ...
        local Success, Result = Library:SafeCall(function()
            for Index, Value in Library.Flags do
                if type(Value) == 'table' and Value.Key then
                    Config[Index] =
                        { Key = tostring(Value.Key), Mode = Value.Mode }
                elseif type(Value) == 'table' and Value.Color then
                    Config[Index] =
                        { Color = '#' .. Value.HexValue, Alpha = Value.Alpha }
                else
                    Config[Index] = Value
                end
            end
    ...
    Library.RefreshConfigsList = function(self, Element)
        ...
        local ConfigFolderName = StringGSub(
            Library.Folders.Configs,
            Library.Folders.Directory .. '/',
            ''
        )
        ...
        for Index, Value in listfiles(Library.Folders.Configs) do
            local FileName = StringGSub(
                Value,
                Library.Folders.Directory .. '\\' .. ConfigFolderName .. '\\',
                ''
            )
            List[Index] = FileName
        end
    ...
    Library.Notification = function(self, Text, Duration, Color, Icon)
        ...
        do
            ...
            if not Icon then
                ...
                Items['Icon'].Instance.ImageColor3 = Icon[2]
                    or FromRGB(255, 255, 255)
            end
        end
        ...
        Library:Thread(function()
            Items['Notification']:Tween(
                nil,
                { BackgroundTransparency = 0, Size = UDim2New(0, 0, 0, 22) }
            )
            ...
            task.delay(Duration + 0.1, function()
                for Index, Value in
                    Items['Notification'].Instance:GetDescendants()
                do
                    if Value:IsA('UIStroke') then
                ...
                Items['Notification']:Tween(
                    nil,
                    { BackgroundTransparency = 1, Size = UDim2New(0, 0, 0, 0) }
                )
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        do
            ...
            Colorpicker.CalculateCount = function(self, Index, YScale, YOffset)
                ...
                local ButtonSize =
                    Items['ColorpickerButton'].Instance.AbsoluteSize
                local Spacing = 4
                ...
                Items['ColorpickerButton'].Instance.Position =
                    UDim2New(1, -XPosition, YScale or 0.5, YOffset or 0)
            end
            ...
            Items['ColorpickerWindow'] = Instances:Create('TextButton', {
                ...
                Position = UDim2New(
                    0,
                    Data.Parent.Instance.AbsolutePosition.X,
                    0,
                    Data.Parent.Instance.AbsolutePosition.Y + 15
                ),
                BorderColor3 = FromRGB(10, 10, 10),
                Visible = false,
            ...
            Items['ColorpickerWindow']:AddToTheme({
                BackgroundColor3 = 'Background',
            })

            Items['ColorpickerWindow']:MakeDraggable()
            Items['ColorpickerWindow']:MakeResizeable(
                Vector2New(200, 180),
        ...
        function Colorpicker:SetOpen(Bool)
            ...
            local Descendants =
                Items['ColorpickerWindow'].Instance:GetDescendants()
            TableInsert(Descendants, Items['ColorpickerWindow'].Instance)

            local NewTween
            for Index, Value in Descendants do
                local ValueIndex =
                    Library:GetTransparencyPropertyFromItem(Value)
        ...
        function Colorpicker:Update(IsFromAlpha)
            ...
            Items['Palette']:Tween(
                ...
                { BackgroundColor3 = FromHSV(self.Hue, 1, 1) }
            )
        ...
        function Colorpicker:SlidePalette(Input)
            ...
            local ValueX = MathClamp(
                1
                    - (
                            Input.Position.X
                            - Items['Palette'].Instance.AbsolutePosition.X
                        )
            ...
            local ValueY = MathClamp(
                1
                    - (
                            Input.Position.Y
                            - Items['Palette'].Instance.AbsolutePosition.Y
                        )
        ...
        function Colorpicker:SlideHue(Input)
            ...
            local ValueY = MathClamp(
                (Input.Position.Y - Items['Hue'].Instance.AbsolutePosition.Y)
                    / Items['Hue'].Instance.AbsoluteSize.Y,
                0,
                1
            )
            ...
            Items['HueDragger']:Tween(
                ...
                { Position = UDim2New(0, 0, PositionY, 0) }
            )
            self:Update()
        end
        ...
        function Colorpicker:SlideAlpha(Input)
            ...
            Items['AlphaDragger']:Tween(
                ...
                { Position = UDim2New(PositionX, 0, 0, 0) }
            )
            self:Update(true)
        end
    ...
    Library.CreateKeybind = function(self, Data)
        ...
        do
            ...
            if Library.KeyList then
                KeyListItem =
                    Library.KeyList:Add(Keybind.Mode, Data.Name, Keybind.Value)
            end
        ...
        local Update = function()
            if KeyListItem then
                ...
                KeyListItem:SetStatus(
                    Keybind.Toggled and 'Active' or 'Inactive'
                )
            end
        end
        ...
        function Keybind:Set(Key)
            if StringFind(tostring(Key), 'Enum') then
                ...
                local KeyString = Keys[Keybind.Key]
                    or StringGSub(Key, 'Enum.', '')
                    or 'None'
                local TextToDisplay = StringGSub(
                    StringGSub(KeyString, 'KeyCode.', ''),
                    'UserInputType.',
                    ''
                ) or 'None'
            ...
            elseif type(Key) == 'table' then
                ...
                local KeyString = Keys[Keybind.Key]
                    or StringGSub(tostring(RealKey), 'Enum.', '')
                    or RealKey
            ...
            Items['Text'].Instance.Size =
                UDim2New(0, Items['Text'].Instance.TextBounds.X, 1, 1)
            Update()
        end
        ...
        Library:Connect(UserInputService.InputBegan, function(Input)
            if
                ...
                or tostring(Input.UserInputType) == Keybind.Key
            then
                if Keybind.Mode == 'Toggle' then
                    Keybind:Press()
                elseif Keybind.Mode == 'Hold' then
    ...
    Library.Page = function(self, Data)
        ...
        do
            ...
            Items['UIGradient'] = Instances:Create('UIGradient', {
                ...
                Color = RGBSequence({
                    RGBSequenceKeypoint(0, FromRGB(255, 255, 255)),
                    RGBSequenceKeypoint(1, FromRGB(108, 108, 108)),
                }),
            })
        ...
        function Page:Turn(Bool)
            ...
            if Bool then
                ...
                Items['Text']:Tween(
                    nil,
                    { TextColor3 = Library.Theme.Accent, TextTransparency = 0 }
                )
                ...
                Items['Text']:Tween(
                    nil,
                    { TextColor3 = Library.Theme.Text, TextTransparency = 0.5 }
                )
    ...
    Library.Pages.SubPage = function(self, Data)
        ...
        do
            ...
            Instances:Create('UIGradient', {
                ...
                Color = RGBSequence({
                    RGBSequenceKeypoint(0, FromRGB(255, 255, 255)),
                    RGBSequenceKeypoint(1, FromRGB(138, 138, 138)),
                }),
            })
                ...
                if type(ValueIndex) == 'table' then
                    for _, Property in ValueIndex do
                        NewTween = Library:FadeItem(
                            ...
                            Property,
                            Bool,
                            SubPage.Window.FadeSpeed or 0.5
                        )
                    end
                else
                    NewTween = Library:FadeItem(
    ...
    Library.Pages.MultiSection = function(self, Data)
        local MultiSection = {
            ...
            Sections = Data.Sections
                or Data.sections
                or { 'Section 1', 'Section 2', 'Section 3' },
            Side = Data.Side or Data.side or 1,
        ...
        for Index, Value in MultiSection.Sections do
            ...
            do
                ...
                SubItems['MiscPixel1']:AddToTheme({
                ...
                SubItems['MiscPixel2']:AddToTheme({
                    BackgroundColor3 = 'Outline',
                })
            ...
            function NewSection:Turn(Bool)
                ...
                local Descendants =
                    SubItems['Content'].Instance:GetDescendants()
                    ...
                    if type(ValueIndex) == 'table' then
                        for _, Property in ValueIndex do
                            NewTween = Library:FadeItem(
                                ...
                                Property,
                                Bool,
                                MultiSection.Window.FadeSpeed or 0.5
                            )
                        end
                    else
                        NewTween = Library:FadeItem(
        ...
        MultiSection.Window.Sections[#MultiSection.Window.Sections + 1] =
            MultiSection
        ...
        do
            ...
            Instances:Create('UIGradient', {
                ...
                Transparency = NumSequence({
                    ...
                    NumSequenceKeypoint(0.718, 0.768750011920929),
    ...
    Library.Sections.Slider = function(self, Data)
        ...
        do
            ...
            if Slider.Compact then
                ...
                Items['Text'].Instance.TextXAlignment =
            ...
            Items['RealSlider']:OnHover(function()
                ...
                Items['RealSlider']:ChangeItemTheme({
                    BackgroundColor3 = 'Hovered Element',
                    BorderColor3 = 'Border',
                })
            end)
        ...
        function Slider:Set(Value)
            Slider.Value = MathClamp(
                Library:Round(Value, Slider.Decimals),
                Slider.Min,
                Slider.Max
            )
            ...
            if Slider.Compact then
                Items['Text'].Instance.Text =
                    `{Slider.Name}: {Slider.Value}{Slider.Suffix}`
            else
        ...
        Items['RealSlider']:Connect('MouseButton1Down', function()
            ...
            local SizeX = (
                MousePos.X - Items['RealSlider'].Instance.AbsolutePosition.X
        ...
        Library:Connect(UserInputService.InputChanged, function(Input)
            ...
            then
                ...
                local SizeX = (
                    MousePos.X
                    - Items['RealSlider'].Instance.AbsolutePosition.X
                )
                    / Items['RealSlider'].Instance.AbsoluteSize.X
                local Value = ((Slider.Max - Slider.Min) * SizeX) + Slider.Min
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        do
            ...
            Items['RealDropdown']:OnHover(function()
                ...
                Items['RealDropdown']:ChangeItemTheme({
                    BackgroundColor3 = 'Hovered Element',
                    BorderColor3 = 'Border',
                })
            end)
        ...
        function Dropdown:Add(Option)
            ...
            function OptionData:Set()
                ...
                if Dropdown.Multi then
                    ...
                    local TextFormat = #Dropdown.Value > 0
                            and TableConcat(Dropdown.Value, ', ')
                        or '--'
    ...
    Library.Sections.Textbox = function(self, Data)
        ...
        do
            ...
            Items['Background']:OnHover(function()
                ...
                Items['Background']:ChangeItemTheme({
                    BackgroundColor3 = 'Hovered Element',
                    BorderColor3 = 'Border',
                })
            end)
        ...
        function Listbox:Add(Option)
            ...
            function OptionData:Set()
                ...
                if Listbox.Multi then
                    ...
                    local TextFormat = #Listbox.Value > 0
                            and TableConcat(Listbox.Value, ', ')
                        or '--'
                else
                    if OptionData.Selected then
                        Listbox.Value = OptionData.Name
